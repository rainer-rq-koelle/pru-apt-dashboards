# AIRPORT FACTSHEET RENDER SCRIPT
...
#
# THE IDEA IS TO RUN THE RENDER LOOP FOR THE FACTSHEETS AS WELL.
# THUS BOTH SCRIPTS WILL BE MERGED IN THE FUTURE.
#
# To-Do
...
apts <- c("EGLL","LGAV","LROP")   #,"EGLL","EBBR", "LEMD")
...
apts %>%
  purrr::walk(
    .f=~rmarkdown::render(
      input  = "apt-factsheet.Rmd"   # master factsheet Rmd
      ...
      , output_file = paste0("./factsheets/", ., ".pdf")
    )
  )
