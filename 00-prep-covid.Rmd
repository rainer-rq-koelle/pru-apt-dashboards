...
ds <- readxl::read_excel(
  ...
  ,sheet= "DATA", range = cell_cols("O:Y"), skip = 10)
...
ds <- ds %>% rename(
  ...
  ,"FLIGHTS_2019" = "Flights 2019", "FLIGHTS_2020" = "Flights 2020"
  ,"VAR_DLY" = "Daily Variation", "VAR_WKLY" = "Weekly Variation"
  ,"MOV_AVG_WK" = "Weekly Moving Average","DAY2019" = "...11")
...
```{r}
write_csv(ds, "./data/COVID-AIRPORT.csv")
```
